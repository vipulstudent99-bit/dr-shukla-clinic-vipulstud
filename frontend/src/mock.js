...
export const servicesData = [
  {
    ...
    description: "Endodontic therapy to treat infected tooth pulp, preserving the natural tooth structure and restoring function."
  },
  {
    id: 2,
    title: "Dental Implants",
    description: "Permanent tooth replacement solution using titanium posts surgically placed in the jawbone to support prosthetic teeth."
  },
  {
    id: 3,
    title: "Teeth Cleaning",
    description: "Professional oral prophylaxis to remove plaque, tartar, and stains, maintaining gum health and preventing periodontal disease."
  },
  {
    id: 4,
    title: "Cosmetic Dentistry",
    description: "Aesthetic dental procedures including teeth whitening, veneers, and smile makeovers to enhance dental appearance."
  },
  {
    id: 5,
  ...
  },
  {
    ...
    description: "Safe removal of damaged or problematic teeth when preservation is not viable, performed with appropriate anesthesia."
  }
];
